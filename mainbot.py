...
def helpme(update,context):
    ...
    msid=update.message.message_id
    helptxt="""
### Haii, ngotak ya kalau mau pakai###

=============================
/mydog  -  Menampilkan gambar ANJINK imute
...
"""
    ...
    if cek.username == "hatakeino" and update.message.chat.type == "private":
...
def main():
    updaterr = Updater(('1279247225:AAF05RNL7_Btek7t8t2ZHG6pz54yA7TgMQA'),use_context=True)
